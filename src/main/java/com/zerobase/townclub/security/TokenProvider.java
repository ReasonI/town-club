...
public class TokenProvider {
  ...
  private static final long TOKEN_EXPIRE_TIME = 2000 * 60 * 60; // 2hour
  ...
  public String generateToken(String identify, String phoneNum, List<String> roles){
    //사용자의 권한 정보 저장
    Claims claims = Jwts.claims().setSubject(phoneNum).setIssuer(identify);
  ...
  public Authentication getAuthentication(String jwt) {
    ...
    UserDetails userDetails = this.userService.loadUserByUsername(this.getPhoneNum(jwt));
